...
- Критичные и высокие findings разобраны: обновлены бaзовые образы до актуальных версий, уязвимости в зависимостях отслеживаются через регулярные обновления requirements.txt.
